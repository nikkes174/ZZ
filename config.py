...
# SMTP_USER = os.getenv("SMTP_USER", "Zamzam.ekb@gmail.com").strip()
...
SMTP_TIMEOUT_SECONDS = _get_int("SMTP_TIMEOUT_SECONDS", 50)
SMTP_FORCE_IPV4 = os.getenv("SMTP_FORCE_IPV4", "true").strip().lower() not in {"0", "false", "no", "off"}
SMTP_PASSWORD = "tgsghnakgbpvqsth"
SMTP_PORT = 587
SMTP_USER = "g71580325@gmail.com"
SMTP_FROM = "g71580325@gmail.com"
